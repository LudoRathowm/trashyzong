...
public class ThirdParty : TroopScript{
...
//			//priority queueue
//			List<Tile> attacktilesInRange = TileHighlight.FindHighlight(GameManager.instance.map[(int)gridPosition.x][(int)gridPosition.y], GetCounterMaxRange(), true);
