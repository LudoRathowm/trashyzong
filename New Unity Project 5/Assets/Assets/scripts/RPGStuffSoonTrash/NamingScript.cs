...
public class NamingScript : MonoBehaviour {
	...
	private enum Cognomina : int{
		...
		Iacomus, Igennus, Ignatius, Indaletius, Indus, Ingenuus, Ingenvinus, Iocundus, Iovinus, Irenaeus, Isatis, Isauricus, Italicus, Ivmarus, Ianuarius, Iavolenus, Iovinianus, Iovius, Iuba, Iulian, Iulianus, Iuncinus, Iuncus, Iunianus, Iustianus, Iustinianus, Iustinus, Iustus, Iuvenlis,
	...
	public static string GeneratePraenomina () {
		
		Praenomina prae =  (Praenomina)(UnityEngine.Random.Range(0, Enum.GetNames(typeof(Praenomina)).Length));
		
		string _prae = prae.ToString();
		return _prae;
		
	}
	public static string GenerateNomina () {
		
		Nomina nomina =  (Nomina)(UnityEngine.Random.Range(0, Enum.GetNames(typeof(Nomina)).Length));

		string _nomina = nomina.ToString();
		return _nomina;
		
	}
	public static string GenerateCognomina () {
		
		Cognomina cogno =  (Cognomina)(UnityEngine.Random.Range(0, Enum.GetNames(typeof(Cognomina)).Length));

		string _cogno = cogno.ToString();
		return _cogno;
